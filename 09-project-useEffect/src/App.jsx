...
function App() {
  ...
  const handleRemovePlace = useCallback(function handleRemovePlace() {
    ...
    const undeletedPlaces = JSON.parse(
      localStorage.getItem("selectedPlaces")
    ).filter((id) => id !== selectedPlace.current);
    localStorage.setItem("selectedPlaces", JSON.stringify(undeletedPlaces));

    // console.log(undeletedPlaces);
    setModalIsOpen(false);
  },[]);

  return (
    <>
      <Modal open={modalIsOpen} onEsc={handleStopRemovePlace}>
        <DeleteConfirmation
